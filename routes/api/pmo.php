...
/**
 * ⚠️ KONTRAK BEKU. Aplikasi mobile PMO di HP toko tidak ikut diperbarui saat
 * cutover, jadi path, nama field request, dan bentuk response di sini tidak
 * boleh berubah. Lihat md/06-KONVENSI-KODE.md §3.
 *
 * Middleware diatur per blok di berkas ini karena penjagaannya berbeda-beda,
 * jadi routes/api.php memasukkannya tanpa atribut tambahan.
 */

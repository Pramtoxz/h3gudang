...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Kelola Toko', href: '/admin/toko' }];
...
export default function TokoIndex({ daftarToko }: Props) {
    ...
    const hapus = () => {
        ...
        router.delete(`/admin/toko/${akanDihapus.kd_toko}`, {
            onFinish: () => {
    ...
    const resetPin = () => {
        ...
        setSedangProses(true);
        router.post(
            `/admin/toko/${akanResetPin.kd_toko}/reset-pin`,
            {},
            {
                onFinish: () => {
                    setSedangProses(false);
                                                ...
                                                <TableCell>
                                                    <div className="flex items-center justify-center gap-1">
                                                        <Button variant="ghost" size="sm" className="h-8 w-8 p-0" asChild>
                                                            <Link href={`/admin/toko/${baris.kd_toko}`} title="Detail">
                                                                <Eye className="h-4 w-4" />
                                                            </Link>
                                                        </Button>
                                                        <Button variant="ghost" size="sm" className="h-8 w-8 p-0" asChild>
                                                            <Link href={`/admin/toko/${baris.kd_toko}/edit`} title="Edit">

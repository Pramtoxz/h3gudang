...
import { destroy, exportMethod, importMethod, index, show } from '@/routes/pmo/sales-spv';
...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Sales & Supervisor', href: index().url }];
                                                ...
                                                <TableCell>
                                                    <div className="flex items-center justify-center gap-1">
                                                        <Button variant="ghost" size="sm" className="h-8 w-8 p-0" asChild>
                                                            <Link href={show(baris.id)} title="Detail">
